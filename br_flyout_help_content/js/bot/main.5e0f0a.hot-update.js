...
/*#__PURE__*/
function () {
  function ToolbarStore(ws, flyout) {
    var _this = this;
    ...
    _initializerDefineProperty(this, "onSearch", _descriptor7, this);

    _initializerDefineProperty(this, "onSaveLoadTypeChange", _descriptor8, this);

    _initializerDefineProperty(this, "onResetClick", _descriptor9, this);

    _initializerDefineProperty(this, "onBrowseClick", _descriptor10, this);

    _initializerDefineProperty(this, "onLoadClick", _descriptor11, this);

    _initializerDefineProperty(this, "handleFileChange", _descriptor12, this);

    _initializerDefineProperty(this, "closeLoadModal", _descriptor13, this);

    _initializerDefineProperty(this, "onSaveClick", _descriptor14, this);

    _initializerDefineProperty(this, "onConfirmSave", _descriptor15, this);

    _initializerDefineProperty(this, "closeSaveModal", _descriptor16, this);

    _initializerDefineProperty(this, "onGoogleDriveClick", _descriptor17, this);

    _initializerDefineProperty(this, "onUndoClick", _descriptor18, this);

    _initializerDefineProperty(this, "onRedoClick", _descriptor19, this);

    _initializerDefineProperty(this, "onZoomInClick", _descriptor20, this);

    _initializerDefineProperty(this, "onZoomOutClick", _descriptor21, this);

    _initializerDefineProperty(this, "onSortClick", _descriptor22, this);
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "onSearch", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "onSaveLoadTypeChange", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      _this4.saveload_type = value;
    };
  }
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "onResetClick", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "onBrowseClick", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this5.load_modal_open = true;
    };
  }
}), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, "onLoadClick", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      if (_this6.saveload_type === 'google-drive') {// TO DO
      } else if (_this6.saveload_type === 'local') {
        var upload = document.getElementById('files');
        upload.click();
      }
    };
  }
}), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, "handleFileChange", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      files.forEach(function (file) {
        if (file.type.match('text/xml')) {
          _this7.readFile(file, dropEvent);
        } else {
      ...
      _this7.closeLoadModal();
    };
  }
}), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, "closeLoadModal", [_dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this8.load_modal_open = false;
    };
  }
}), _descriptor14 = _applyDecoratedDescriptor(_class.prototype, "onSaveClick", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this9.save_modal_open = true;
    };
  }
}), _descriptor15 = _applyDecoratedDescriptor(_class.prototype, "onConfirmSave", [_dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      if (_this10.saveload_type === 'google-drive') {// TO DO
      } else if (_this10.saveload_type === 'local') {
      ...
      _this10.closeSaveModal();
    };
  }
}), _descriptor16 = _applyDecoratedDescriptor(_class.prototype, "closeSaveModal", [_dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this11.save_modal_open = false;
    };
  }
}), _descriptor17 = _applyDecoratedDescriptor(_class.prototype, "onGoogleDriveClick", [_dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      var symbol = _this12.ws.activeSymbols({
...
}), _descriptor18 = _applyDecoratedDescriptor(_class.prototype, "onUndoClick", [_dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor19 = _applyDecoratedDescriptor(_class.prototype, "onRedoClick", [_dec14], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor20 = _applyDecoratedDescriptor(_class.prototype, "onZoomInClick", [_dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this13.zoomOnPlusMinus(true);
    };
  }
}), _descriptor21 = _applyDecoratedDescriptor(_class.prototype, "onZoomOutClick", [_dec16], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this14.zoomOnPlusMinus(false);
    };
  }
}), _descriptor22 = _applyDecoratedDescriptor(_class.prototype, "onSortClick", [_dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
//# sourceMappingURL=main.5e0f0a.hot-update.js.map