...
throw new Error("Module build failed (from ./node_modules/svgo-loader/index.js):\nError: ENOENT: no such file or directory, open 'bot-sprite.svg#ic-arrow-usage'");
...
/***/ "./src/components/flyout-block-group.jsx":
/*!***********************************************!*\
  !*** ./src/components/flyout-block-group.jsx ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _flyout_block_jsx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./flyout-block.jsx */ "./src/components/flyout-block.jsx");
...
var FlyoutBlockGroup = function FlyoutBlockGroup(props) {
  var onInfoClick = props.onInfoClick,
      block_nodes = props.block_nodes;
  var block_type = block_nodes[0].getAttribute('type');
  var block_meta = Blockly.Blocks[block_type].meta();
  var display_name = block_meta.display_name,
      description = block_meta.description;
  ...
  }, display_name)), react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("p", {
    className: "flyout__item-description"
  }, description, onInfoClick && react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("a", {
    className: "flyout__item-info",
    onClick: onInfoClick
  }, Object(_utils_tools__WEBPACK_IMPORTED_MODULE_7__["translate"])('Learn more.'))), Object.keys(block_nodes).map(function (key) {
    return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_flyout_block_jsx__WEBPACK_IMPORTED_MODULE_6__["default"], {
      key: key,
...
FlyoutBlockGroup.propTypes = {
  block_nodes: prop_types__WEBPACK_IMPORTED_MODULE_5__["PropTypes"].array,
  onInfoClick: prop_types__WEBPACK_IMPORTED_MODULE_5__["PropTypes"].func
};
/* harmony default export */ __webpack_exports__["default"] = (FlyoutBlockGroup);
...
/* harmony import */ var _scratch_help_content_help_content_config__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_scratch_help_content_help_content_config__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _stores_connect__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../stores/connect */ "./src/stores/connect.js");
/* harmony import */ var _utils_tools__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/tools */ "./src/utils/tools.js");
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var block_config = help_string && _help_content_config__WEBPACK_IMPORTED_MODULE_8__[block_type];
    var component_order = block_config && block_config.order;
    ...
    }, block_config && component_order.map(function (component) {
      switch (component) {
        case 'description':
          return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_help_components_flyout_text_jsx__WEBPACK_IMPORTED_MODULE_10__["default"], {
            text: help_string.description
          });

        case 'explanation':
          return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_help_components_flyout_text_jsx__WEBPACK_IMPORTED_MODULE_10__["default"], {
            text: help_string.explanation
          });
    ...
    }, Object(_utils_tools__WEBPACK_IMPORTED_MODULE_14__["translate"])('Previous')), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("button", {
      className: "flyout__button flyout__button-next",
      onClick: function onClick() {
        return onSequenceClick(block_type, true);
      }
    }, Object(_utils_tools__WEBPACK_IMPORTED_MODULE_14__["translate"])('Next'))));
  };
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_stores_connect__WEBPACK_IMPORTED_MODULE_13__["connect"])(function (_ref) {
  var flyout = _ref.flyout;
  return {
...
Blockly.DataCategory.addCreateButton = function (xmlList, workspace) {
  ...
  var callback = function callback(button) {
    ...
    var category = Blockly.derivWorkspace.toolbox_.getSelectedItem();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            el_scratch_area = document.getElementById(scratch_area_name);
...
/* harmony import */ var core_js_modules_es6_number_parse_int__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/es6.number.parse-int */ "./node_modules/core-js/modules/es6.number.parse-int.js");
/* harmony import */ var core_js_modules_es6_number_parse_int__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_number_parse_int__WEBPACK_IMPORTED_MODULE_6__);
...
var FlyoutStore = (_dec = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, _dec2 = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, _dec3 = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, _dec4 = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, _dec5 = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, _dec6 = mobx__WEBPACK_IMPORTED_MODULE_7__["action"].bound, (_class = (_temp =
/*#__PURE__*/
function () {
  function FlyoutStore() {
    ...
    _initializerDefineProperty(this, "is_help_content", _descriptor, this);

    _initializerDefineProperty(this, "block_nodes", _descriptor2, this);

    _initializerDefineProperty(this, "flyout_content", _descriptor3, this);

    _initializerDefineProperty(this, "flyout_width", _descriptor4, this);

    _initializerDefineProperty(this, "is_visible", _descriptor5, this);
  }
  ...
  _proto.setContents = function setContents(xml_list) {
    ...
    if (xml_list.type === 'search') {
      ...
      var has_result = blocks.length;
      processed_xml = [];

      if (!has_result) {
        var label = document.createElement('label');
        label.setAttribute('text', Object(_utils_lang_i18n__WEBPACK_IMPORTED_MODULE_8__["translate"])('No Blocks Found'));
        processed_xml.push(label);
      } else {
        var _label = document.createElement('label');

        _label.setAttribute('text', Object(_utils_lang_i18n__WEBPACK_IMPORTED_MODULE_8__["translate"])('Result(s)'));
    ...
    var xml_list_group = this.groupBy(processed_xml);
    this.flyout_content = Object(mobx__WEBPACK_IMPORTED_MODULE_7__["observable"])(xml_list_group);
  ...
  _proto.setVisibility = function setVisibility(is_visible) {
    ...
    if (!is_visible) {
      this.flyout_content = Object(mobx__WEBPACK_IMPORTED_MODULE_7__["observable"])([]);
    }
  }
  /**
  ...
  _proto.onSequenceClick = function onSequenceClick(block_name, should_go_next) {
    var toolbox = Blockly.derivWorkspace.toolbox_;
    var selected_category = toolbox.getSelectedItem();
    var xml_list = toolbox.getCategoryContents(selected_category);
    var xml_list_group = this.groupBy(xml_list, true);
    var current_block = xml_list.find(function (xml) {
      return xml.getAttribute('type') === block_name;
    });
    var current_block_index;
    Object.keys(xml_list_group).forEach(function (key, index) {
      if (current_block.getAttribute('type') === key) {
        current_block_index = index;
      }
    });
    var last_position = Object.keys(xml_list_group).length - 1;

    var adjustIndexOutOfBounds = function adjustIndexOutOfBounds(current_index, last_index) {
      var current_pos = current_index;
    ...
    var increment = should_go_next ? 1 : -1;
    current_block_index = adjustIndexOutOfBounds(current_block_index + increment, last_position);
    var block_type = Object.keys(xml_list_group).find(function (key, index) {
      return current_block_index === index;
    });
    var target_blocks = xml_list_group[block_type];
    this.showHelpContent(target_blocks);
  };

  _proto.showHelpContent = function showHelpContent(block_node) {
    Object.keys(block_node).forEach(function (key) {
      var node = block_node[key];
      var block_hw = Blockly.Block.getDimensions(node);
      node.setAttribute('width', block_hw.width);
      node.setAttribute('height', block_hw.height);
    });
  ...
  _proto.groupBy = function groupBy(nodes, should_include_block_only) {
    if (should_include_block_only === void 0) {
      should_include_block_only = false;
    }
  ...
  return FlyoutStore;
}(), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "is_help_content", [mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "block_nodes", [mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "flyout_content", [mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "flyout_width", [mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "is_visible", [mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _applyDecoratedDescriptor(_class.prototype, "setContents", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "setContents"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setVisibility", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "setVisibility"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "initBlockWorkspace", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "initBlockWorkspace"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setFlyoutWidth", [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, "setFlyoutWidth"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onSequenceClick", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "onSequenceClick"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "showHelpContent", [_dec6], Object.getOwnPropertyDescriptor(_class.prototype, "showHelpContent"), _class.prototype)), _class));
...
//# sourceMappingURL=main.0cf63d.hot-update.js.map