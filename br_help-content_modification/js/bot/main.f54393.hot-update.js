...
Blockly.Toolbox.prototype.showSearch_ = function (search_term) {
  console.log(search_term); // eslint-disable-line
  ...
  block_contents.forEach(function (block_content) {
    ...
    console.log(block_type.toUpperCase().includes(search_term)); // eslint-disable-line
    // block_name matched
...
//# sourceMappingURL=main.f54393.hot-update.js.map