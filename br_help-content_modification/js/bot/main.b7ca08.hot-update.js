...
function () {
  function ToolbarStore(flyout) {
    ...
    _initializerDefineProperty(this, "contract_status", _descriptor7, this);

    _initializerDefineProperty(this, "onRunClick", _descriptor8, this);

    _initializerDefineProperty(this, "onStartClick", _descriptor9, this);

    _initializerDefineProperty(this, "onSearchBlur", _descriptor10, this);

    _initializerDefineProperty(this, "onSearch", _descriptor11, this);

    _initializerDefineProperty(this, "onBotnameTyped", _descriptor12, this);

    _initializerDefineProperty(this, "onSaveLoadTypeChange", _descriptor13, this);

    _initializerDefineProperty(this, "onResetClick", _descriptor14, this);

    _initializerDefineProperty(this, "onBrowseClick", _descriptor15, this);

    _initializerDefineProperty(this, "onLoadClick", _descriptor16, this);

    _initializerDefineProperty(this, "handleFileChange", _descriptor17, this);

    _initializerDefineProperty(this, "closeLoadModal", _descriptor18, this);

    _initializerDefineProperty(this, "onSaveClick", _descriptor19, this);

    _initializerDefineProperty(this, "onConfirmSave", _descriptor20, this);

    _initializerDefineProperty(this, "closeSaveModal", _descriptor21, this);

    _initializerDefineProperty(this, "onGoogleDriveClick", _descriptor22, this);

    _initializerDefineProperty(this, "onUndoClick", _descriptor23, this);

    _initializerDefineProperty(this, "onRedoClick", _descriptor24, this);

    _initializerDefineProperty(this, "onZoomInClick", _descriptor25, this);

    _initializerDefineProperty(this, "onZoomOutClick", _descriptor26, this);

    _initializerDefineProperty(this, "onSortClick", _descriptor27, this);
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "contract_status", [mobx__WEBPACK_IMPORTED_MODULE_14__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "onRunClick", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this2.contract_status = 'succeed';
    };
  }
}), _applyDecoratedDescriptor(_class.prototype, "contractStatus", [mobx__WEBPACK_IMPORTED_MODULE_14__["computed"]], Object.getOwnPropertyDescriptor(_class.prototype, "contractStatus"), _class.prototype), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "onStartClick", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this3.is_toolbox_open = !_this3.is_toolbox_open;
      var toolbox = Blockly.derivWorkspace.toolbox_;

      if (_this3.is_toolbox_open) {
        _this3.flyout.setVisibility(false);
...
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "onSearchBlur", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, "onSearch", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, "onBotnameTyped", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (values) {
      var bot_name = values.botname;
      _this6.file_name = bot_name;
    };
  }
}), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, "onSaveLoadTypeChange", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      _this7.saveload_type = value;
    };
  }
}), _descriptor14 = _applyDecoratedDescriptor(_class.prototype, "onResetClick", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor15 = _applyDecoratedDescriptor(_class.prototype, "onBrowseClick", [_dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this8.load_modal_open = true;
    };
  }
}), _descriptor16 = _applyDecoratedDescriptor(_class.prototype, "onLoadClick", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor17 = _applyDecoratedDescriptor(_class.prototype, "handleFileChange", [_dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      files.forEach(function (file) {
        if (file.type.match('text/xml')) {
          _this10.readFile(file, dropEvent);
        } else {
      ...
      _this10.closeLoadModal();
    };
  }
}), _descriptor18 = _applyDecoratedDescriptor(_class.prototype, "closeLoadModal", [_dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this11.load_modal_open = false;
    };
  }
}), _descriptor19 = _applyDecoratedDescriptor(_class.prototype, "onSaveClick", [_dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this12.save_modal_open = true;
    };
  }
}), _descriptor20 = _applyDecoratedDescriptor(_class.prototype, "onConfirmSave", [_dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      if (_this13.saveload_type === 'google-drive') {// TO DO
      } else if (_this13.saveload_type === 'local') {
        var file_name = _this13.file_name;
      ...
      _this13.closeSaveModal();
    };
  }
}), _descriptor21 = _applyDecoratedDescriptor(_class.prototype, "closeSaveModal", [_dec14], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this14.save_modal_open = false;
    };
  }
}), _descriptor22 = _applyDecoratedDescriptor(_class.prototype, "onGoogleDriveClick", [_dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      var symbol = _this15.ws.activeSymbols({
...
}), _descriptor23 = _applyDecoratedDescriptor(_class.prototype, "onUndoClick", [_dec16], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor24 = _applyDecoratedDescriptor(_class.prototype, "onRedoClick", [_dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor25 = _applyDecoratedDescriptor(_class.prototype, "onZoomInClick", [_dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this16.zoomOnPlusMinus(true);
    };
  }
}), _descriptor26 = _applyDecoratedDescriptor(_class.prototype, "onZoomOutClick", [_dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      _this17.zoomOnPlusMinus(false);
    };
  }
}), _descriptor27 = _applyDecoratedDescriptor(_class.prototype, "onSortClick", [_dec20], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
//# sourceMappingURL=main.b7ca08.hot-update.js.map