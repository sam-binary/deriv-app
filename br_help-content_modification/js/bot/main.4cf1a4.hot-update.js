...
Blockly.Toolbox.prototype.showSearch_ = function (search) {
  var flyout_content = [];
  var search_term = search.toUpperCase();
...
function () {
  function ToolbarStore(flyout) {
    ...
    _initializerDefineProperty(this, "onBotnameTyped", _descriptor10, this);
...
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "onBotnameTyped", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  initializer: function initializer() {
    ...
    return function () {
      if (_this12.saveload_type === 'google-drive') {// TO DO
        ...
        var file_name = _this12.file_name;
        var xml = Blockly.Xml.workspaceToDom(Blockly.mainWorkspace);
...
//# sourceMappingURL=main.4cf1a4.hot-update.js.map