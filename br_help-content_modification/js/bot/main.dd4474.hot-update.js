...
Blockly.Toolbox.prototype.showSearch_ = function (search) {
  ...
  block_contents.forEach(function (block_content) {
    ...
    console.log(block_type.toUpperCase(), block_type.toUpperCase().includes(search_term)); // eslint-disable-line
    // block_name matched

    if (block_type.toUpperCase().includes(search_term)) {
      console.log('GG'); // eslint-disable-line
  ...
  console.log(flyout_content); // eslint-disable-line
...
//# sourceMappingURL=main.dd4474.hot-update.js.map